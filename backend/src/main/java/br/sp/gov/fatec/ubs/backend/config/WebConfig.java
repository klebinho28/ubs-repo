...
public class WebConfig implements WebMvcConfigurer {
    ...
    public void addCorsMappings(CorsRegistry registry) {
        ...
        registry.addMapping("/api/") // Define que a configuração será para todos os endpoints que começam com
                                     // "/api/"
                .allowedOrigins("http://localhost:4200") // Permite requisições de http://localhost:4200 (frontend do
                                                         // Angular)
